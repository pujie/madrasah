<?php
echo form_open('students/edit_handler');
...
echo '<p />';
echo form_label('Father','father_name',array('class'=>'text_float_medium'));
echo form_input('father_name',$student->father_name) . '<br />';
echo form_label('Father Occupation','father_occupation',array('class'=>'text_float_medium'));
echo form_input('father_occupation',$student->father_occupation) . '<br />';
echo form_label('Mother','mother_name',array('class'=>'text_float_medium'));
echo form_input('mother_name',$student->mother_name) . '<br />';
echo form_label('Mother Occupation','mother_occupation',array('class'=>'text_float_medium'));
echo form_input('mother_occupation',$student->mother_occupation) . '<br />';
